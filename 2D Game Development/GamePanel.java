...
public class GamePanel extends JPanel implements Runnable {
	...
	final int maxScreenCol = 16; // This is for the column, use as width (horizontal), this should be used as length(vertical), just followed what's on the video
	final int maxScreenRow = 12; // This is for the row, use as length(vertical), this should be used as width(horizontal), just followed what's on the video
	
	/* Correct implementation should be
	 * maxScreenCol = 12
	 * maxScreenRow = 16
	 * 
	 * screenWidth = maxScreenRow * tileSize;
	 * screenHeight = maxScreenCol * tileSize;
	 */
	
	final int screenWidth = maxScreenCol * tileSize; // 768px screen horizontal size
	final int screenHeight = maxScreenRow * tileSize; // 576px screen vertical size
	...
	// this set's the player's default position
	int playerX = 100;
	int playerY = 100;
	int playerSpeed = 4;
